...
public class ModuleIOSparkMax implements ModuleIO {
  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      case 0:
        driveSparkMax =
            new SparkMax(Constants.Drivetrain.FRONT_LEFT_DRIVE_ID, MotorType.kBrushless);
        turnSparkMax =
            new SparkMax(Constants.Drivetrain.FRONT_LEFT_STEER_ID, MotorType.kBrushless);
      ...
      case 1:
        driveSparkMax =
            new SparkMax(Constants.Drivetrain.FRONT_RIGHT_DRIVE_ID, MotorType.kBrushless);
        turnSparkMax =
      ...
      case 3:
        driveSparkMax =
            new SparkMax(Constants.Drivetrain.BACK_RIGHT_DRIVE_ID, MotorType.kBrushless);
        turnSparkMax =
            new SparkMax(Constants.Drivetrain.BACK_RIGHT_STEER_ID, MotorType.kBrushless);
