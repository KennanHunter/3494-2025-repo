...
public class Module {
  private static final double WHEEL_RADIUS = Units.inchesToMeters(1.6775698129167518);//1.6703883408404518 inches//1.6723303021786367 inches //1.671774376846477);//2.031000299198190);
