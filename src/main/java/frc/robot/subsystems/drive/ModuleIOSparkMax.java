...
public class ModuleIOSparkMax implements ModuleIO {
    ...
    public ModuleIOSparkMax(int index) {
        ...
        switch (index) {
            case 0:
                driveSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.FRONT_LEFT_DRIVE_ID, MotorType.kBrushless);
                turnSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.FRONT_LEFT_STEER_ID, MotorType.kBrushless);
                turnAbsoluteEncoder =
                        new AnalogInput(Constants.Drivetrain.FRONT_LEFT_TURN_ENCODER_ID);
                absoluteEncoderOffset =
                        new Rotation2d(
                                Constants.Drivetrain.FRONT_LEFT_OFFSET); // MUST BE CALIBRATED
                break;
            case 1:
                driveSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.FRONT_RIGHT_DRIVE_ID, MotorType.kBrushless);
                turnSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.FRONT_RIGHT_STEER_ID, MotorType.kBrushless);
                turnAbsoluteEncoder =
                        new AnalogInput(Constants.Drivetrain.FRONT_RIGHT_TURN_ENCODER_ID);
                absoluteEncoderOffset =
                        new Rotation2d(
                                Constants.Drivetrain.FRONT_RIGHT_OFFSET); // MUST BE CALIBRATED
                break;
            case 2:
                driveSparkMax =
                        new SparkMax(Constants.Drivetrain.BACK_LEFT_DRIVE_ID, MotorType.kBrushless);
                turnSparkMax =
                        new SparkMax(Constants.Drivetrain.BACK_LEFT_STEER_ID, MotorType.kBrushless);
                turnAbsoluteEncoder =
                        new AnalogInput(Constants.Drivetrain.BACK_LEFT_TURN_ENCODER_ID);
                absoluteEncoderOffset =
            ...
            case 3:
                driveSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.BACK_RIGHT_DRIVE_ID, MotorType.kBrushless);
                turnSparkMax =
                        new SparkMax(
                                Constants.Drivetrain.BACK_RIGHT_STEER_ID, MotorType.kBrushless);
                turnAbsoluteEncoder =
                        new AnalogInput(Constants.Drivetrain.BACK_RIGHT_TURN_ENCODER_ID);
                absoluteEncoderOffset =
                        new Rotation2d(
                                Constants.Drivetrain.BACK_RIGHT_OFFSET); // MUST BE CALIBRATED
                break;
            default:
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        Logger.recordOutput(
                "Encoder" + index + " output voltage", turnAbsoluteEncoder.getVoltage());
        Logger.recordOutput(
        ...
        inputs.odometryDrivePositionsRad =
                drivePositionQueue.stream()
                        .mapToDouble(
                                (Double value) ->
                                        Units.rotationsToRadians(value) / DRIVE_GEAR_RATIO)
                        .toArray();
