// Copyright (c) 2025 FRC 6328, Kennan Hunter
...
public class FieldConstants {
  ...
  public enum AprilTagLayoutType {
    ...
    AprilTagLayoutType(String name) {
      // TODO: Test this, originally it had Constants.DisableHAL, why? It looks like some kind of
      // simulation vs real robot. 6328 uses the code relative path when they do path generation
      if (false) {
        try {
          layout =
