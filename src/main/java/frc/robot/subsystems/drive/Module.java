...
public class Module {
    private static final double WHEEL_RADIUS =
            Units.inchesToMeters(1.895796963450933); // Units.inchesToMeters(2.0);
        ...
        if (turnRelativeOffset == null && inputs.turnAbsolutePosition.getRadians() != 0.0) {
            ...
            turnRelativeOffset =
                    inputs.turnAbsolutePosition.minus(
                            inputs.turnPosition); // minus(inputs.turnPosition);
        }

        // Run closed loop turn control
        if (angleSetpoint != null) {
            // System.out.println(turnFeedback.calculate(getAngle().getRadians(),
            // angleSetpoint.getRadians()) + "|" + getAngle().getRadians() + "|" +
            ...
            if (speedSetpoint != null) {
                ...
                double adjustSpeedSetpoint =
                        speedSetpoint * Math.cos(turnFeedback.getError());
